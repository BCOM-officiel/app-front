...
import styles from "./HeaderOthers.module.css";
  ...
  const LinksLeft = (
    <>
      <Button
        ...
        onClick={() => navigate("/")}
        sx={{ mx: 4, fontWeight: 800, color: "#fff" }}
      >
        Home
      </Button>
      <Button
        className={`${styles.navButton} ${
          selectedButton === "/talents" ? styles.selectedWithBar : ""
        }`}
        onClick={() => navigate("talents")}
        sx={{ mr: 4, fontWeight: 800, color: "#fff" }}
      >
        Talents
      </Button>
      {/* Ajoutez des conditions similaires pour les autres liens */}
      <Button
        className={`${styles.navButton} ${
          selectedButton === "/team" ? styles.selectedWithBar : ""
        }`}
      ...
      <Button
        className={`${styles.navButton} ${
          selectedButton === "/contact" ? styles.selectedWithBar : ""
        }`}
        onClick={() => navigate("contact")}
        sx={{ mr: 4, fontWeight: 800, color: "#fff" }}
      >
